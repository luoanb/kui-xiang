...
const handleClickStart = async () => {
  console.log('[Playground_vue]', "handleClickStart")
  const res = await window.ipcRenderer.invoke("startEggServer", serverPath.value)
  console.log('[Playground_vue]', res)
  resStr.value = res
}
const handleClickStop = async () => {
  console.log('[Playground_vue]', "handleClickStop")
  try {
...
const checkUpdate = async () => {
  console.log('[Playground_vue]', "checkUpdate")
  try {
...
const downloadUpdate = async () => {
  console.log('[Playground_vue]', "downloadUpdate")
  try {
...
const installUpdate = async () => {
  console.log('[Playground_vue]', "installUpdate")
  try {
